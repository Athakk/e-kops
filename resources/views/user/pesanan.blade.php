<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from freshcart.codescandy.com/pages/account-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2023 04:41:14 GMT -->
        ...
        <div class="py-5">
            <div class="container">
                <div class="row w-100 align-items-center gx-lg-2 gx-0">
                    ...
                    <div class="col-xxl-5 col-lg-5 me-2 d-none d-lg-block">
                        <form action="#">
                            <div class="input-group">
                                <input class="form-control rounded" type="search" placeholder="Cari produk" />
                            ...
                            <div class="mt-2">
                                <button type="button" class="btn btn-outline-gray-400 text-muted w-100"
                                    data-bs-toggle="modal" data-bs-target="#locationModal"><i
                                        class="feather-icon icon-map-pin me-2"></i>Pick Location</button>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($pesanan as $item)
                                            <tr>
                                                ...
                                                <td class="align-middle border-top-0">{{ $item->pesanan->tanggal }}
                                                </td>
                                                <td class="align-middle border-top-0">{{ $item->qty }}
                                                </td>
                                                <td class="align-middle border-top-0">
                                                    <span class="badge bg-warning">
                                                        @if ($item->pesanan->status == 0)
                                                            Belum bayar
                                                        @elseif($item->pesanan->status == 1)
                                                            Sudah bayar
                                                        @else
                                                            Selesai
                                                        @endif
                                                ...
                                                <td>
                                                    <button
                                                        class="btn btn-primary {{ $item->pesanan->status !== 1 ? 'd-none' : '' }}"
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <span class="small text-muted">©
                            ...
                            E-Kops SMK Negeri 1 Surabaya. All rights reserved.</span>
                    </div>
