                    ...
                    <div class="col-xxl-5 col-lg-5 d-none d-lg-block">
                        <form action="{{ route('searchItem') }}" method="POST">
                            ...
                            <div class="input-group">
                                <input class="form-control rounded" type="search" id="query" name="query"
                                    placeholder="Cari produk">
                                <span class="input-group-append">
                                    <button class="btn bg-white border border-start-0 ms-n10 rounded-0 rounded-end"
                                        type="submit" fdprocessedid="57rmao">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <a href="#!" class="btn btn-dark {{ count($keranjang) == 0 ? 'd-none' : '' }}">Perbarui
                    Keranjang</a>
            </div>
        </div>
    </div>
                        ...
                        @foreach ($kategori as $item)
                            <li class="nav-item mb-2">
                                <form action="" method="get">
                                    @csrf
                                    <a href="{{ route('searchItem.kategori', $item->id) }}" class="nav-link">
                                        {{ $item->nm_kategori }}
                                    </a>
                                </form>
                            </li>
