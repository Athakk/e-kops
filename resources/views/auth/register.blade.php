...
<!-- Mirrored from freshcart.codescandy.com/pages/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2023 04:41:14 GMT -->
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                        <div class="mb-lg-9 mb-5">
                            <h1 class="mb-1 h2 fw-bold">Selamat Datang</h1>
                            <p>Masukkan email-mu untuk memulai.</p>
                        </div>
                        <!-- form -->
                        <form action="{{ route('createRegister') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col">
                                    <!-- input --><input type="text" class="form-control" id="nama"
                                        name="nama" placeholder="Masukkan nama" aria-label="Masukkan nama" required>
                                </div>
                                <div class="col">
                                    <!-- input --><input type="text" class="form-control" id="whatsapp"
                                ...
                                <!-- btn -->
                                <div class="col-12 d-grid"> <button type="submit" class="btn btn-primary">Buat
                                        akun</button>
                                </div>
